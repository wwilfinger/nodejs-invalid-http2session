...
async function main() {
  const authority = process.env.APP_AUTHORITY !== undefined ? process.env.APP_AUTHORITY : 'https://localhost:50051'
  const cacert = process.env.APP_CACERT !== undefined ? process.env.APP_CACERT : './../cert/ca-cert.pem'
